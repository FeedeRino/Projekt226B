...
public class GamesData implements GamesDAO {
	...
	public ArrayList<Game> list() {
		Game g1 = new Game("Agar.io", "Multiplayer-Spiel", "Miniclip", 3,
		...
		Game g4 = new Game("Mahjong Titans", "Familienunterhaltung", "Microsoft Corporation", 3,
